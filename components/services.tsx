    ...
    <div className="flex flex-col gap-6 lg:pt-10">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div className="flex gap-2 text-xs text-gray-500 mb-2">
          <span className="flex bg-gray-100 border px-2 py-1 rounded-full"><div className="p-1">  <svg width="8" height="8" viewBox="0 0 8 8" fill="gray">
...
<div className="lg:col-span-2 bg-white rounded-3xl p-10 shadow-sm relative pb-0">
  <div className="flex flex-col lg:flex-row items-center ">
    ...
    <div className="flex-1">
      ...
      {/* DESKTOP BUTTON ONLY */}
      <button className="hidden lg:block bg-[#019c70] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#017a59] transition ml-[-40px]">
        Book Appointment
      </button>
    </div>
  ...
  <button className="lg:hidden mt-6 ml-[-2.5rem] w-full bg-[#019c70] text-white  px-8 py-3 rounded-xl font-semibold hover:bg-[#017a59] transition">
    Book Appointment
  </button>
